...
void StrategieSurfaceOrdreID::relierPoints(std::vector<std::vector<char>>& grille, std::vector<Point>& points)
{
...
void StrategieSurfaceDistanceMin::relierPoints(std::vector<std::vector<char>>& grille, std::vector<Point>& points) 
{
